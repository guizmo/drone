...
<div id="header-top" class="clearfix">
    <div class="container">
        ...
        <div id="header-top-inside" class="clearfix">
            ...
            <div class="col-md-3 <?php //print $header_top_left_grid_class; ?>">
                <!-- #header-top-left -->
            ...
            <div class="col-md-6 <?php //print $header_top_left_grid_class; ?>">
                <!-- #header-top-left -->
            ...
            <div class="col-md-3 <?php //print $header_top_right_grid_class; ?>">
                <!-- #header-top-right -->
